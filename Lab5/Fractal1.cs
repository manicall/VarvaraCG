...
namespace Lab5
{
    ...
    class Fractal1
    {
        ...
        {
            // Корни многочлена
            Complex firstRoot = 3.0 / 2.0;
            Complex secondRoot = new Complex(2, 1);
            Complex thirdRoot = new Complex(2, -1);
        ...
        private Complex func(Complex complex)
        {
            ...
            return -15.0 / 2.0 + Complex.Pow(complex, 3) + 11.0 * complex - 11.0 * Complex.Pow(complex, 2) / 2.0;
        }

        private Complex funcDiff(Complex complex)
        {
            // Общий вид уравнения для построения бассейна ньютона
            return 11 - 11 * complex + 3 * Complex.Pow(complex, 2);
        }
